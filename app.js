...
//Question 01
 ...
 alert("Welcome to Muhammad Noman Website ");
...
alert(name);
alert(age+" years old");
alert("Certified Web And Mobile Application Development");
...
// Does ordered 5 T-shirt(s) on XYZ Clothing store”.
...
var exchange_rate=163.80;
ans=exchange_rate*parseInt(rs);
document.write("<h1>Currency in PKR</h1>");
document.write("Total Currensy in PKR: "+Answer+"<br>");
...
var pass1="Web"
var pass2="Mobile"
password1=prompt("Enter 1st Password")
password2=prompt("Enter 2nd Password")
var result,password1,password2;
if (password1=="" && password2=="" ){
result="Please Enter a Valid Password";
}
else if (password1 == pass1 && password2==pass2) {
result = "Correct!You Entered The Password is Matched the Orignal Password";
} else 
result = "You Enter a Wrong Password";
alert(result);
...
var arrayA = ["My name is Noman","I am Student of BS"];
...
// Copy 3 array elements from cities array to selected Cities
// array.
